...
function ProfileHeader({ userStats, userData, user }: ProfileHeaderProps) {
  ...
  return (
    <div
      className="relative mb-8 bg-gradient-to-br from-[#12121a] to-[#1a1a2e] rounded-2xl p-4 md:p-8 border
      ...
      <div className="relative flex flex-col md:flex-row items-center gap-4 md:gap-8">
        <div className="relative group">
          ...
          <img
            src={user.imageUrl}
            alt="Profile"
            className="w-20 h-20 md:w-24 md:h-24 rounded-full border-4 border-gray-800/50 relative z-10 group-hover:scale-105 transition-transform"
          />
          {userData.isPro && (
            <div
        ...
        <div className="text-center md:text-left">
          <div className="flex flex-col md:flex-row items-center gap-2 md:gap-3 mb-2 justify-center md:justify-start">
            <h1 className="text-2xl md:text-3xl font-bold text-white max-w-[250px] md:max-w-none break-words">{userData.name}</h1>
            {userData.isPro && (
          ...
          <p className="text-gray-400 flex items-center gap-2 justify-center md:justify-start break-all">
