...
function SnippetCard({ snippet }: { snippet: Snippet }) {
  ...
  return (
    <motion.div
      ...
      >
        <Link href={`/snippets/${snippet._id}`} className="absolute inset-0 z-10" />
        <div className="p-6">
          {/* Header */}
          <div className="flex items-start justify-between mb-4">
            ...
            <div
              className="absolute top-5 right-5 z-20 flex gap-4 items-center"
            >
            ...
            <div>
              ...
              <div className="flex items-center gap-3 text-sm text-gray-400">
                <div className="flex items-center gap-2">
                  ...
                  <Link href={`/profile/${snippet.userId}`} className="truncate max-w-[150px] hover:text-blue-400 transition-colors relative z-20">
                    {snippet.userName}
                  </Link>
                </div>
              </div>
