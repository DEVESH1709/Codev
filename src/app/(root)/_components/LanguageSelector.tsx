  ...
  return (
    <div className="relative" ref={dropdownRef}>
      <motion.button
        ...
        className={`group relative flex items-center gap-1.5 sm:gap-3 px-2.5 sm:px-4 py-1.5 sm:py-2.5 bg-[#1e1e2e]/80 
      ...
      >
        ...
        <span className="text-gray-200 min-w-[80px] text-left group-hover:text-white transition-colors hidden md:block">
