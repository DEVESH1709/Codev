  ...
  return (
    <div className="relative" ref={dropdownRef}>
      ...
      >
        ...
        <span className="text-gray-300 min-w-[80px] text-left group-hover:text-white transition-colors hidden md:block">
          {currentTheme?.label}
        </span>
      ...
      <AnimatePresence>
        {isOpen && (
          <motion.div
            ...
            className="absolute top-full left-0 mt-2 w-full min-w-[200px] md:min-w-[240px] bg-[#1e1e2e]/95 
